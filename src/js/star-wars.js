...
const starWars = {
    ...
    getStarshipsById: async (id) => (await (await fetch(`https://swapi.py4e.com/api/starships/${id}`)).json()),
    getVehiclesById: async (id) => (await (await fetch(`https://swapi.py4e.com/api/vehicles/${id}`)).json()),
